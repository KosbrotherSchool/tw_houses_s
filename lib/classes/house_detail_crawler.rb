	...
	def crawl_detail(house_id)
		...
		if detail.size == 0
			...
			begin
				...
				2.upto li_num do |num|


					if detail.css("li")[num].children[0].children.to_s.index("格局")
					...
					if detail.css("li")[num].children[0].children.to_s.index("坪數")
						house.total_area = detail.css("li")[num].children[1].children.to_s.to_d
					end

					if detail.css("li")[num].children[0].children.to_s.index("面積")
						house.total_area = detail.css("li")[num].children[1].children.to_s.to_d
					end

					if detail.css("li")[num].children[0].children.to_s.index("樓層")
					...
					if detail.css("li")[num].children[0].children.to_s.index("屋齡")
						age_s = detail.css("li")[num].children[1].children.to_s
						if age_s.index("年")
					...
					if detail.css("li")[num].children[0].children.to_s.index("型態/類型")
						type_s = detail.css("li")[num].children[1].children.to_s
					...
					if detail.css("li")[num].children[0].children.to_s.index("車位")
